...
// Configuration
//
// If you would like to configure the generation process because of custom EAV
// and attribute models please create a new file in this folder called
// `config_*.go` where `*` can be any name.
// @todo rethink that process and provide a better solution.
//
// You must then use the `init()` function to append new values or change
// existing values of the configuration variables.
//
// All defined variables in the file `config.go` can be changed. File is
// documented.
//
